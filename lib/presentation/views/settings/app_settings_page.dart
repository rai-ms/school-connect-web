...
import 'package:student_management/presentation/views/settings/bloc/settings_bloc.dart';
...
class AppSettingsPage extends StatelessWidget {
  ...
  Widget _buildLanguageTile(BuildContext context, SettingsState settingsState) {
    return InkWell(
  ...
  void _showLanguageDialog(BuildContext context, SettingsState settingsState) {
    showDialog(
      context: context,
      builder: (dialogContext) => AlertDialog(
        ...
        content: Column(
          ...
          children: AppLanguage.values.map((lang) {
            final isSelected = settingsState.language == lang;
            return ListTile(
              title: Text(
                lang.language,
                style: isSelected
                    ? AppStyles.semiMedium.semiBold.greenCyan
                    : AppStyles.semiMedium.medium.white,
              ),
              trailing: isSelected
                  ? const Icon(Icons.check, color: AppColors.greenCyan)
                  : null,
              onTap: () {
                context.read<SettingsBloc>().add(UpdateLanguage(lang));
